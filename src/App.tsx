...
function App() {
  ...
  const [pageSize, setPageSize] = useState("A4"); // eslint-disable-line no-unused-vars
  ...
  return (
    <>
      <div
        className="w-[210mm] mx-auto flex justify-between items-center px-4"
      >
        <button
      ...
      <div
        className={`w-[${width}] h-screen mt-5 mx-auto py-10 border-[10px] border-gray-800 rounded-lg overflow-y-auto `}
      >
